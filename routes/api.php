...
Route::prefix('customer')->group(function () {
    ...
    Route::middleware('auth:customer')->group(function () {
        ...
        Route::prefix('maintenance-request')->group(function () {
            ...
            Route::post('/cancelled/{maintenanceRequest}', [\App\Http\Controllers\MaintenanceRequestController::class,'cancelled']);
        ...
        Route::prefix('planting-request')->group(function () {
            ...
            Route::post('/cancelled/{plantingRequest}', [\App\Http\Controllers\PlantingRequestController::class, 'cancelled']);
